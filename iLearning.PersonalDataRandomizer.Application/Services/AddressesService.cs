...
public class AddressesService : IAddressesService
{
    ...
    private string GetHouseAndFlat(string country, int maxHouseNumber, int maxFlatNumber)
    {
        return country.ToLower() switch
        {
            ...
            Country.Poland => GetForeignHouseAndFlat(maxHouseNumber, maxFlatNumber),
            Country.USA => GetForeignHouseAndFlat(maxHouseNumber, maxFlatNumber),
            _ => "",
        };
    }
    ...
    private string GetForeignHouseAndFlat(int maxHouseNumber, int maxFlatNumber)
    {
        var flatNumber = GetFlat(maxFlatNumber);
